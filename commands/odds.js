...
module.exports.run = async (bot, message, args) => {
  ...
  message.reply("no one liked my odds game :()")
...
//   log.send("`" + `${timechange} [COMMAND]: 'odds' Dare: ${dare}, Author: ${message.author.username}, Server: ${message.guild.name} (${users}/${bots})` + "`")
}
